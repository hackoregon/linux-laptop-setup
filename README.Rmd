...
5. The scripts are modular - you only need to install what you're going to use. By task:
    ...
    * VirtualBox and Vagrant hosting (64-bit VA bare metal only): If you want to host or build VirtualBox guests or Vagrant boxes, type `./vbox-vagrant`. You will need to log out and back in again after the install to join the `vboxusers` group.
